...
function playDuckAnimation() {
  var current = document.getElementById('duck')
  var newDuck = current.cloneNode(true)
  current.parentNode.replaceChild(newDuck, current)
  newDuck.className = "duckAnimate"
}
